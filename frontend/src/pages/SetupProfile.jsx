    ...
    <PageLayout isDarkMode={isDarkMode}>
      <div className="w-full max-w-[672px] flex flex-col gap-12">
        <div className="text-center space-y-4">
          ...
          <h1 className="text-zinc-800 dark:text-zinc-100 text-5xl font-extrabold leading-tight">프로필을 완성해주세요</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            <div className="flex flex-col items-center gap-3">
              <div 
                ...
                className="relative w-36 h-36 bg-gray-100 dark:bg-zinc-700 rounded-full border-2 border-zinc-200 dark:border-zinc-600 flex justify-center items-center cursor-pointer overflow-hidden group shadow-inner"
              >
                {profile.previewUrl ? (
            ...
            <div className="flex flex-col items-center gap-6 pt-4">
              ...
              <div className="text-center text-neutral-400 dark:text-zinc-500 text-xs uppercase leading-relaxed tracking-tighter">
